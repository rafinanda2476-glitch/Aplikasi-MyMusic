...
class PlayerController:
    ...
    def nextByArtist(self):
        ...
        artist_songs = [s for s in artist_songs if s.id != self.current_song.id]
        
        if artist_songs:
            # Add next artist song to queue
            next_song = artist_songs[0]
            ...
            # No more songs by this artist, try different artist
